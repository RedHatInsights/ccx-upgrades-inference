...
COMPONENTS="ccx-upgrades-data-eng ccx-upgrades-inference insights-results-smart-proxy dvo-writer ccx-mock-ams ccx-upgrades-rhobs-mock ccx-upgrades-sso-mock" # space-separated list of components to laod
