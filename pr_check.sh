...
COMPONENTS="ccx-upgrades-data-eng ccx-upgrades-inference ccx-insights-results valkey-writer ccx-smart-proxy dvo-writer ccx-mock-ams ccx-upgrades-rhobs-mock ccx-upgrades-sso-mock" # space-separated list of components to laod
...
EXTRA_DEPLOY_ARGS="--set-parameter ccx-upgrades-inference/IMAGE=quay.io/cloudservices/ccx-upgrades-inference"
